...
import vending.hardware.subsistemas.economico.Efectivo;
...
public class RepositorioLite implements IRepositorio {
   ...
   public void cargarCaja(ControladorDePagos ctrl) {
      try {
         Class.forName("org.sqlite.JDBC");
         Connection conn = DriverManager.getConnection("jdbc:sqlite:" + dbname);
         vending.hardware.subsistemas.economico.RepositorioLite.load(ctrl, conn, empresa);
      } catch (Exception e) {
         System.out.println(e.toString());
      }
   }
   ...
   public void guardarCaja(ControladorDePagos ctrl) {
      try {
         Class.forName("org.sqlite.JDBC");
         Connection conn = DriverManager.getConnection("jdbc:sqlite:" + dbname);
         vending.hardware.subsistemas.economico.RepositorioLite.save(ctrl, conn, empresa);
      } catch (Exception e) {
         System.out.println(e.toString());
      }
   }
