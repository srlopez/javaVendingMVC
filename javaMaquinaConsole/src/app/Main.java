...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("MVC Vending Consola ...");
        ...
        Refresco[][] matrizBebidas = { { new Refresco("Coca Zero", 2.10f, true), new Refresco("Fanta Naranja", 1.80f) },
                { new Refresco("Chus", 1.90), new Refresco("Sprite Zero", 2.80f, true) }, };
        Dispensador dispensadorRefrescos = new Dispensador(matrizBebidas);
        sistemaSeguridad = new SeguridadFormula();
        /*
         * sistemaPago = new ControladorDePagos(); cambiamos el Dispensador, cambiamos
         * el sistema de seguridad, y utilizamos el mismo sistema de pago ¿?! Qué
         * ocurre?
         */
        ...
        Producto[][] matriz3 = { { new Golosina("KitKat", 1.10) }, { new Refresco("Sprite Z", 1.80, true) },
